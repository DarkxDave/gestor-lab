...
exports.exportAllForms = async (req, res, next) => {
  try {
    ...
    if (!sample_id) return res.status(400).send('Parámetro sample_id requerido. Ej: /export/all?sample_id=XYZ');
    ...
    try {
      ...
      console.log('TPA sheet skipped or failed:', err.message);
      // Continue without TPA sheet if it fails
    }
    ...
    try {
      ...
      console.log('RAM sheet skipped or failed:', err.message);
      // Continue without RAM sheet if it fails
    }
    ...
    try {
      ...
      console.log('CTCFE sheet skipped:', err.message);
    }
    ...
    try {
      ...
      console.log('Entero sheet skipped:', err.message);
    }
    ...
    try {
      ...
      console.log('RMYL sheet skipped:', err.message);
    }
    ...
    try {
      ...
      console.log('Sal sheet skipped:', err.message);
    }
    ...
    try {
      ...
      console.log('Saureus sheet skipped:', err.message);
    }
