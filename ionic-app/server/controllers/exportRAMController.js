...
exports.addSheetForSample = async (wb, sample_id, data) => {
  ...
  // Estilo base y funciones auxiliares
  ...
  ws.mergeCells('B5:K5'); ws.getCell('B5').value = 'Fechas y análisis'; ws.getCell('B5').alignment = { horizontal: 'center' }; ws.getCell('B5').font = { bold: true }; ws.getCell('B5').fill = headerFill; setBorder(5, 2, 5, 11);
  ...
  ws.mergeCells('B11:K11'); ws.getCell('B11').value = 'Set de Análisis'; ws.getCell('B11').alignment = { horizontal: 'center' }; ws.getCell('B11').font = { bold: true }; ws.getCell('B11').fill = headerFill; setBorder(11, 2, 11, 11);
  // Fila 1
  ...
  // Sección: Siembra
  ws.mergeCells('B16:K16'); ws.getCell('B16').value = 'Siembra'; ws.getCell('B16').alignment = { horizontal: 'center' }; ws.getCell('B16').font = { bold: true }; ws.getCell('B16').fill = headerFill; setBorder(16, 2, 16, 11);
  ...
  ws.mergeCells('B21:K21'); ws.getCell('B21').value = 'Manual de Inocuidad y Certificación Parte II Sección III Cap IV pto 1 y 2'; ws.getCell('B21').alignment = { horizontal: 'center' }; ws.getCell('B21').font = { bold: true }; ws.getCell('B21').fill = headerFill; setBorder(21, 2, 21, 11);
  ...
  ws.mergeCells('B26:K26'); ws.getCell('B26').value = 'Datos'; ws.getCell('B26').alignment = { horizontal: 'center' }; ws.getCell('B26').font = { bold: true }; ws.getCell('B26').fill = headerFill; setBorder(26, 2, 26, 11);
  // Entradas base
  ...
  // Dilución inicial en B33 desde datos_dilucion_log10_1; si falta, usar -1 por defecto
  const baseDil = toNumber(data.datos_dilucion_log10_1);
  ws.getCell('B33').value = (baseDil === null ? -1 : baseDil);
